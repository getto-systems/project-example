...
use crate::{
    auth::ticket::kernel::api::data::AuthDateTime,
    z_lib::api::repository::data::{RegisterResult, RepositoryError},
};
...
pub mod test {
    ...
    use crate::{
        auth::ticket::kernel::api::data::{AuthDateTime, AuthNonce, ExpireDateTime},
        z_lib::api::repository::data::{RegisterResult, RepositoryError},
    };
