use crate::auth::ticket::remote::kernel::infra::{AuthClock, IssueAuthTicketRepository};

use crate::auth::ticket::remote::kernel::data::{AuthTicketId, ExpansionLimitDuration};
