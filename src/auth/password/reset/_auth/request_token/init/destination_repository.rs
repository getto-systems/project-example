...
use crate::auth::password::reset::_auth::request_token::infra::ResetTokenDestinationRepository;

use crate::auth::{
    login_id::_auth::data::LoginId,
    password::reset::_auth::request_token::data::{
...
pub mod test {
    ...
    use crate::{
        auth::{
            login_id::_auth::data::LoginId,
            password::reset::_auth::request_token::data::ResetTokenDestination,
        },
