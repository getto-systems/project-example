...
test("link", () => {
    ...
    expect(link.getNav_password_authenticate().href).toEqual("?-password-authenticate=authenticate")
    expect(link.getNav_password_reset_requestToken().href).toEqual("?-password-reset=request-token")
