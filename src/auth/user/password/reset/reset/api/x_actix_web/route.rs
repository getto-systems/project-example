...
use crate::auth::user::password::reset::reset::proxy::init::ActiveResetPasswordProxyMaterial;
...
pub async fn service_reset(
    ...
    let mut action = ActiveResetPasswordProxyMaterial::action(&feature, request_id);
