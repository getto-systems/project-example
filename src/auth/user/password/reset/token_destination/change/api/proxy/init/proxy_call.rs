...
pub struct TonicChangeResetTokenDestinationProxyCall<'a> {
    service: GoogleTonicService<'a>,
}

impl<'a> TonicChangeResetTokenDestinationProxyCall<'a> {
...
impl<'a> ProxyCall for TonicChangeResetTokenDestinationProxyCall<'a> {
    type Request = String;
