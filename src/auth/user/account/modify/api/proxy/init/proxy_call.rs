...
pub struct TonicModifyAuthUserAccountProxyCall<'a> {
    service: GoogleTonicService<'a>,
}

impl<'a> TonicModifyAuthUserAccountProxyCall<'a> {
...
impl<'a> ProxyCall for TonicModifyAuthUserAccountProxyCall<'a> {
    type Request = String;
