...
use crate::auth::{
    ...
    auth_ticket::remote::kernel::x_actix_web::header::HEADER_NONCE,
};
...
use crate::auth::auth_ticket::remote::kernel::infra::AuthNonceMetadata;

use crate::{
    auth::auth_ticket::remote::kernel::data::AuthNonce,
